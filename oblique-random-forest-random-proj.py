...
class ObliqueDecisionTreeClassifier:
    def __init__(self, max_depth=None, n_projections=15):
        self.root = None
    ...
    def get_best_split(self, X, Y):
        ...
        for _ in range(self.n_projections):
            ...
            for th in thresholds:
                ...
                Xi_left, Yi_left = X[left_indices], Y[left_indices]
                Xi_right, Yi_right = X[right_indices], Y[right_indices]
...
class ObliqueRandomForest:
    def __init__(self, n_estimators=10, max_depth=None, n_projections=15):
    ...
    def fit(self, X, y):
        ...
        for _ in range(self.n_estimators):
            ...
            tree = ObliqueDecisionTreeClassifier(
                max_depth=self.max_depth, n_projections=self.n_projections
            )
...
def main():
    ...
    classifier_local = ObliqueRandomForest(
        n_estimators=10, max_depth=10, n_projections=15
    )
    ...
    clf_final = ObliqueRandomForest(n_estimators=10, max_depth=10, n_projections=15)
